...
namespace DeusMod.Dusts
{
    public class GlowDust : ModDust
    {
        ...
        public override void OnSpawn(Dust dust)
        {
            ...
            dust.shader = new Terraria.Graphics.Shaders.ArmorShaderData(new Ref<Effect>(DeusMod.Instance.Assets.Request<Effect>("Effects/GlowDust", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value), "GlowDustPass");
        }
